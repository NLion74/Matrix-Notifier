...
# The auth_secret set on the server, this assummes that authentication is enabled.
# Note that if authentication is disabled you can still pass the Authorization header, but it will be ignored
auth_secret = ""
...
try:
    ...
    res = requests.post(matrix_notifier_url, headers={"Channel": room_id, "Authorization": auth_secret}, data="Hello, I am working even with authorization.".encode("utf-8"))
